...
def submit_batch_job(arguments, hidden_size, batch_size):
    ...
    env = {
        **os.environ,
        "EXP_PARAMS": f"-S model.hidden_size={hidden_size} -S train.batch_size={batch_size}"
    }
...
if __name__ == "__main__":
    ...
    for hidden_size, batch_size in itertools.product(hidden_size_list, batch_size_list):
        submit_batch_job(arguments, hidden_size, batch_size)
