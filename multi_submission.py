...
def submit_batch_job(arguments, batch_size, hidden_size):
    ...
    env = {
        **os.environ,
        "EXP_PARAMS": f"-S train.batch_size={batch_size} -S model.hidden_size={hidden_size}"
    }
...
if __name__ == "__main__":
    ...
    for batch_size, hidden_size in itertools.product(batch_size_list, hidden_size_list):
        submit_batch_job(arguments, batch_size, hidden_size)
